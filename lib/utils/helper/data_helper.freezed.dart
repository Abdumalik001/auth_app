...
class _$DataHelperImpl implements _DataHelper {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, title, desc, iconPath, icon, url,
      type, id, isSelected, activeTheme);
...
abstract class _DataHelper implements DataHelper {
  factory _DataHelper(
      ...
      final int? id,
      final bool isSelected,
      final ActiveTheme activeTheme}) = _$DataHelperImpl;
